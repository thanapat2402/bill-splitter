...
const dom = {
  ...
  shortcutAddPersonBtn: document.getElementById("shortcutAddPersonBtn"),
  shortcutAddExpenseBtn: document.getElementById("shortcutAddExpenseBtn"),
  mobileAddPersonBtn: document.getElementById("mobileAddPersonBtn"),
  mobileAddExpenseBtn: document.getElementById("mobileAddExpenseBtn"),
  mobileShareLink: document.getElementById("mobileShareLink"),
  mobileSummaryLink: document.getElementById("mobileSummaryLink"),
  mobileQuickActionsMenu: document.getElementById("mobileQuickActionsMenu"),
  mobileQuickActionsToggleBtn: document.getElementById(
    "mobileQuickActionsToggleBtn",
  ),
  ...
  expenseModalCloseBtn: document.getElementById("expenseModalCloseBtn"),
